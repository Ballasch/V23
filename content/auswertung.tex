...
Die Resonanz spaltet sich in zwei Peaks auf, da die Kugelsymmetrie des Resonators durch die Blenden gebrochen wird. Der Abstand der Peaks ist ungefähr proportional zur Dicke der Blenden. Dies ist analog zur linearen Abhängigkeit der Aufspaltung der Zustände im Magnetfeld, dem Zeeman-Effekt.
\begin{figure}[H]
  \centering
  \begin{tabular}{cc}
...
Die $2.08 \,\si{\kilo\hertz}$ Resonanz weist daher auf den Zustand $l=1$ und $m=0$ und die $2.25 \,\si{\kilo\hertz}$ Resonanz weist auf den Zustand $l=1$ und $m=\pm 1$ hin. Der Vergleich mit den Legendrepolynomen ist ebenfalls in der Abbildung \ref{fig:9mm} zu sehen. 
\begin{figure}[H]
  \centering
  \begin{tabular}{cc}
...
Die Abbildung \ref{fig:fk1} zeigt, dass die Amplitude der Resonanzfrequenzen mit steigender Frequenz abnimmt. Dies liegt an der Transferfunktion zwischen Lautsprecher und Mikrofon, da der Lautsprecher und das Mikrofon die höheren Frequenzen nicht in gleicher Intensität wiedergeben bzw. aufzeichnen können. 
Dies kann damit erklärt werden, dass höhere Frequenzen höhere Leistungen benötigen. Damit sinkt die Amplitude aufgrund der beschränkten Leistung der Soundkarte.
...
Des Weiteren haben die Peaks der ersten Ordnungen für Blenden mit größerem Durchmesser eine höhere Amplitude. Somit werden die Peaks erster Ordnungen durch kleinere Blendendurchmesser unterdrückt. 
...
Außerdem sind kleine Peaks kurz vor dem hineingezoomten Band zu sehen. Es handelt sich um einen Defektzustand, welches analog zu dem Defektzustand in einem n-Dotierung eines Halbleiters ist.  
...
Stattdessen sind die Bänder der alternierenden Kette innerhalb der Bandlücken der einzelnen Zylinder zu finden. Die Bänder sind dabei eher zu höheren Frequenzen verschoben. Dies ist damit zu erklären, dass die Aneinanderreihung der Zylinder zu destruktiver Interferenz an den Resonanzen führt. Es kann nur zu Resonanzen in der alternierenden Kette kommen, wenn nicht beide Zylindertypen die Resonanzen des jeweils anderen Typen stark unterdrücken. 
